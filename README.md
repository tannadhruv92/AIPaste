...
A Windows system tray application that enhances your clipboard with AI-powered text processing. Transform, rewrite, translate, or apply custom actions to any copied text with a simple hotkey.
...
- **System Tray App** - Runs quietly in background, accessible via hotkey
